...
- extraProperties: Object - The new extraProperties of the file, (this will update or create new keys in extraproperties, not delete)

the extraproperties can not be deleted yet WIP :( only replaced or added.
